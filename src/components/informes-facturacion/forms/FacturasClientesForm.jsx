...
export default function FacturasClientesForm({ obtenerFacturasClientes }) {
  ...
  const handleSubmitForm = () => {
    ...
    obtenerFacturasClientes(fechaInicialAdaptada, fechaFinalAdaptada);
  };

  return (
    <Box m={2} sx={{ width: '40%' }}>
      <CabeceraForms label="Buscar facturas de clientes" />

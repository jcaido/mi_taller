        ...
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.tableContainer}>
            <View style={styles.container}>
              ...
              <Text style={styles.fechaFactura}>Fecha</Text>
              <Text style={styles.numeroFactura}>Nª</Text>
              <Text style={styles.proveedor}>Proveedor</Text>
              <Text style={styles.cif}>CIF</Text>
              <Text style={styles.baseImponible}>BI</Text>
              <Text style={styles.tipoIVA}>(%)</Text>
              <Text style={styles.cuotaIVA}>IVA</Text>
              <Text style={styles.totalFactura}>Total</Text>
            </View>
          </View>
